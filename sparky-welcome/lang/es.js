...
dict.entries['main']['system'] = "Información del sistema";
dict.entries['main']['welcome'] = "¡Bievenido al mundo de Sparky!";
dict.entries['main']['keep'] = "Manténganse en contacto con la comunidad de Sparky";
dict.entries['main']['exit'] = "Salida";
dict.entries['main']['git'] = "Git repo";
dict.entries['main']['install'] = "Instalación ";
dict.entries['main']['remaster'] = "Construye Sparky";
